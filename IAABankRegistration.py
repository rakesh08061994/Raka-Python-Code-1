...
# --------------------------------------------------------------------------------------------------------------------------------------------
check = int(input(". Registration: 1 \n Login: 2 "))
if(check == 1):
    print("Please fill your information: ")
    User_Name = input("Enter Your First Name: ")
    User_ID = int(input("Choose your Account ID: "))
    credit_amount = int(input("Enter Money in your account: "))
    User_Passwd = input("Enter your password: ")
    if(User_ID in Users_Details['Users_ID']):
        print("Please Choose Another Unique User_ID: ")
    else:
        # Users_Details[Users_Name][User_ID] = User_Name  # Users_Name
        Users_Details[Users_ID][User_ID] = User_ID  # Users_ID
        Users_Details[Users_Balance][User_ID] = credit_amount  # Users_Balance
        Users_Details[Users_Password][User_ID] = User_Passwd  # Users_Password
        print("You have successfully submited the registration!")
