...
#NOTE:  Dictionary is unordered but mutable in nature & in the form of 'Key:Value' Pair. 
#       Strictly No duplication allowed in key (but Value can be).
...
Attempt = 3                                                                                                                 # Attempt range keep 3 (count keep trying to make equal then attempt to make while condition false )
